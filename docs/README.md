...
- [029 — Private Web Search and Extraction](specs/029-selfhost-web-research.md) — Defines native private search/extraction APIs, response-size controls, acceptance requirements, and the required consumer follow-up.
