...
- [029 — Private Web Search and Extraction](specs/029-selfhost-web-research.md) — Defines the approved private search/extraction contract, bounded compatibility interface, acceptance requirements, and required consumer follow-up.
