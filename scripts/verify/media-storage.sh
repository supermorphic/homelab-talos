...
echo 'Media storage acceptance passed: media + media-storage Kustomizations Ready and media-data PVC Bound. Run the hardlink proof in docs/phases/phase-11-media.md next.'
