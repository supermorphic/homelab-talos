...
echo 'Media storage acceptance passed: media + media-storage Kustomizations Ready and media-data PVC Bound. Run mise exec -- just test integration media-hardlink next.'
