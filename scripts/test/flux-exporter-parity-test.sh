...
dedicated_json='{
  "status":"success","data":{"result":[
    {"metric":{"__name__":"gotk_resource_info","job":"dedicated","instance":"10.0.0.1:8080","pod":"dedicated-a","service":"flux-kube-state-metrics","endpoint":"http","namespace":"monitoring","container":"kube-state-metrics","customresource_group":"kustomize.toolkit.fluxcd.io","customresource_version":"v1","customresource_kind":"Kustomization","exported_namespace":"flux-system","name":"cluster-apps","ready":"True","suspended":"false"},"value":[1,"1"]},
    {"metric":{"__name__":"gotk_resource_info","job":"dedicated","instance":"10.0.0.1:8080","pod":"dedicated-a","service":"flux-kube-state-metrics","endpoint":"http","namespace":"monitoring","container":"kube-state-metrics","customresource_group":"helm.toolkit.fluxcd.io","customresource_version":"v2","customresource_kind":"HelmRelease","exported_namespace":"monitoring","name":"kube-prometheus-stack","ready":"True","suspended":"false"},"value":[1,"1"]},
    {"metric":{"__name__":"gotk_resource_info","job":"dedicated","instance":"10.0.0.1:8080","pod":"dedicated-a","service":"flux-kube-state-metrics","endpoint":"http","namespace":"monitoring","container":"kube-state-metrics","customresource_group":"source.toolkit.fluxcd.io","customresource_version":"v1","customresource_kind":"GitRepository","exported_namespace":"flux-system","name":"flux-system","ready":"True","suspended":"false"},"value":[1,"1"]},
    {"metric":{"__name__":"gotk_resource_info","job":"dedicated","instance":"10.0.0.1:8080","pod":"dedicated-a","service":"flux-kube-state-metrics","endpoint":"http","namespace":"monitoring","container":"kube-state-metrics","customresource_group":"source.toolkit.fluxcd.io","customresource_version":"v1","customresource_kind":"OCIRepository","exported_namespace":"monitoring","name":"grafana","ready":"True","suspended":"false"},"value":[1,"1"]},
    {"metric":{"__name__":"gotk_resource_info","job":"dedicated","instance":"10.0.0.1:8080","pod":"dedicated-a","service":"flux-kube-state-metrics","endpoint":"http","namespace":"monitoring","container":"kube-state-metrics","customresource_group":"source.toolkit.fluxcd.io","customresource_version":"v1","customresource_kind":"HelmRepository","exported_namespace":"monitoring","name":"prometheus-community","ready":"False","suspended":"true"},"value":[1,"1"]}
  ]}}
'

candidate_json='{
  "status":"success","data":{"result":[
    {"metric":{"__name__":"gotk_candidate_resource_info","job":"bundled","instance":"10.0.0.2:8080","pod":"kube-prometheus-stack-kube-state-metrics-a","service":"kube-prometheus-stack-kube-state-metrics","endpoint":"http","namespace":"monitoring","container":"kube-state-metrics","customresource_group":"kustomize.toolkit.fluxcd.io","customresource_version":"v1","customresource_kind":"Kustomization","exported_namespace":"flux-system","name":"cluster-apps","ready":"True","suspended":"false"},"value":[1,"1"]},
