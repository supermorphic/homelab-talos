...
register_group_shell_case automation n8n-failure-notifications scripts/test/n8n-failure-notifications-test.sh
...
register_group_shell_case observability monitoring-flux-exporter-validator scripts/test/monitoring-flux-exporter-test.sh
register_group_shell_case observability monitoring-verifier scripts/test/monitoring-verify-test.sh
