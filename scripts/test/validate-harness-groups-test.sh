...
expect_lines "$(printf '%s\n' "$all_work" | tail -n 6)" \
	$'python:scripts/test/core\npython:scripts/test/scenarios\npython:tests/probes/vpn\npython:scripts/test\nruff:check\nruff:format'
