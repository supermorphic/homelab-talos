...
cp "$binding_catalog" "$fixture_root/complete-binding-catalog.yaml"
yq -i 'del(.executions.ci-core)' "$binding_catalog"
assert_group_rejected_before_execution ci-core core "$binding_plan"
rg -q "CI execution 'ci-core' is empty" "$binding_output"
cp "$fixture_root/complete-binding-catalog.yaml" "$binding_catalog"
yq -i '.executions.ci-core = []' "$binding_catalog"
assert_group_rejected_before_execution ci-core core "$binding_plan"
rg -q "CI execution 'ci-core' is empty" "$binding_output"
cp "$fixture_root/complete-binding-catalog.yaml" "$binding_catalog"
