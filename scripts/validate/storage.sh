...
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-snapshot") | .spec.cron' "$jobs")" == '0 2 * * *' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-snapshot") | .spec.task' "$jobs")" == 'snapshot' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-snapshot") | .spec.groups | join(" ")' "$jobs")" == 'default' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-snapshot") | .spec.retain' "$jobs")" == '7' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-snapshot") | .spec.concurrency' "$jobs")" == '2' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-backup") | .spec.cron' "$jobs")" == '0 3 * * *' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-backup") | .spec.task' "$jobs")" == 'backup' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-backup") | .spec.groups | join(" ")' "$jobs")" == 'default' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-backup") | .spec.retain' "$jobs")" == '7' ]]
[[ "$(yq ea -r 'select(.kind == "RecurringJob" and .metadata.name == "daily-backup") | .spec.concurrency' "$jobs")" == '2' ]]
